...
<head>
  ...
  <link rel="stylesheet" href="./src/styles/about_us.css">
...
<body>
  ...
  <section class="about-box">
    ...
    <div class="team">
      ...
      <div class="img-div">
        <div class="pro-div">
          <img src="./src/images/pavara.jpg" alt="Deesara" class="pro-img">
          <h4>Pavara Helamina</h4>
        </div>
        <div class="pro-div">
          <img src="./src/images/deesara.jpg" alt="Pavara" class="pro-img">
          <h4>Deesara Rupasingha</h4>
        </div>


        <div class="pro-div">
          <img src="./src/images/malsha.jpg" alt="Malsha" class="pro-img">
          <h4>Malsha Haren</h4>
        </div>

        <div class="pro-div">
          <img src="./src/images/Rasindu.jpg" alt="Rasidu" class="pro-img">
          <h4>Rasidu Anthoney</h4>
        </div>
